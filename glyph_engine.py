...
GLYPH_METADATA = {
    "GLYPH_00": {"symbol": "⚓", "name": "Anchor", "ring": 1, "meaning": "Grounding, return, safe base"},
    "GLYPH_01": {"symbol": "🛡️", "name": "Aegis", "ring": 1, "meaning": "Protection, shield, ward"},
    "GLYPH_02": {"symbol": "🪨", "name": "Stone", "ring": 1, "meaning": "Endurance, heaviness, pressure"},
    "GLYPH_03": {"symbol": "🕳️", "name": "Hollow", "ring": 1, "meaning": "Emptiness, numb, echo"},
    "GLYPH_04": {"symbol": "🌊", "name": "Flood", "ring": 1, "meaning": "Overwhelm, release, meltdown"},
    "GLYPH_05": {"symbol": "🔄", "name": "Loop", "ring": 1, "meaning": "Repeating, stuck, recursion"},
    "GLYPH_06": {"symbol": "🌀", "name": "Vortex", "ring": 1, "meaning": "Anxiety, pull, spiral"},
    "GLYPH_07": {"symbol": "🌌", "name": "Void", "ring": 1, "meaning": "Night, possibility, unknown"},
    "GLYPH_08": {"symbol": "🕯️", "name": "Clarity", "ring": 1, "meaning": "Insight, focus, ritual"},
    "GLYPH_09": {"symbol": "🪞", "name": "Mirror", "ring": 1, "meaning": "Reflection, self, identity"},
    "GLYPH_10": {"symbol": "🔥", "name": "Flare", "ring": 1, "meaning": "Activation, pain, breakthrough"},
    "GLYPH_11": {"symbol": "🌠", "name": "Wish", "ring": 1, "meaning": "Hope, dream, longing"},

    "GLYPH_12": {"symbol": "🎭", "name": "Mask", "ring": 2, "meaning": "Persona, masking, code-switch"},
    "GLYPH_13": {"symbol": "🔇", "name": "Mute", "ring": 2, "meaning": "Silence, shutdown, freeze"},
    "GLYPH_14": {"symbol": "💬", "name": "Dialogue", "ring": 2, "meaning": "Conversation, opening, consent"},
    "GLYPH_15": {"symbol": "🩸", "name": "Blood", "ring": 2, "meaning": "Wound, truth, cost"},
    "GLYPH_16": {"symbol": "🪙", "name": "Coin", "ring": 2, "meaning": "Value, worth, exchange"},
    "GLYPH_17": {"symbol": "🗣️", "name": "Voice", "ring": 2, "meaning": "Speaking up, signal, alert"},
    "GLYPH_18": {"symbol": "🧃", "name": "Juice", "ring": 2, "meaning": "Energy, nourishment, reward"},
    "GLYPH_19": {"symbol": "🧩", "name": "Puzzle", "ring": 2, "meaning": "Complexity, difference, fit"},
    "GLYPH_20": {"symbol": "🧵", "name": "Thread", "ring": 2, "meaning": "Connection, fate, timeline"},
    ...
    "GLYPH_26": {"symbol": "🚪", "name": "Door", "ring": 3, "meaning": "Threshold, change, boundary"},
    "GLYPH_27": {"symbol": "🛤️", "name": "Track", "ring": 3, "meaning": "Path, progress, journey"},
    "GLYPH_28": {"symbol": "🧭", "name": "Compass", "ring": 3, "meaning": "Direction, navigation, choice"},
    "GLYPH_29": {"symbol": "📿", "name": "Beads", "ring": 3, "meaning": "Prayer, focus, anchor"},
    "GLYPH_30": {"symbol": "🪜", "name": "Ladder", "ring": 3, "meaning": "Ascent, progress, escape"},

    # Special/Combined
    "GLYPH_31": {"symbol": "🪞/🔁", "name": "Mirror/Loop", "ring": 4, "meaning": "Recursive reflection, memory"},
    "GLYPH_32": {"symbol": "🪞⁻", "name": "Broken Mirror", "ring": 4, "meaning": "Fragmentation, alternate self"},
    "GLYPH_33": {"symbol": "🌫️🔥", "name": "Fog/Flare", "ring": 4, "meaning": "Dissolution, catastrophic change"},
    "GLYPH_34": {"symbol": "⚓✨", "name": "Bright Anchor", "ring": 4, "meaning": "Renewed hope, stabilized base"},
    "GLYPH_35": {"symbol": "🛡️⬛", "name": "Shadow Shield", "ring": 4, "meaning": "Hidden defense, dissociation"}
}
...
def encode_glyph(glyph, modifier=None):
    return {
