(function () {
  ...
  function updateDebug() {
    ...
    debugFields.apiUrl.textContent = `${API_PATH}?client=card&holdMs=30000&minHoldMs=8000&maxAgeMs=120000&ts=${Date.now()}`;
  ...
  async function poll() {
    ...
    const apiUrl = `${API_PATH}?client=card&holdMs=30000&minHoldMs=8000&maxAgeMs=120000&ts=${Date.now()}`;
    state.polling = true;
