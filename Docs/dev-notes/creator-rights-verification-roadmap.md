...
- Canonical rights registry at `/rights/`.
...
- Keep the Data Room executive overview, Publishing, Shelf, Technology, Press, copyright/legal pages, and individual record pages linked into the rights registry.
- Keep the public registry searchable by title, category, work type, availability, license, and AI-use terms.
...
- Keep `/registry/` as the remembered public route for checking records.
