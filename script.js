...
const commandRewards = {
  ...
  PLAZA_DRIFT: {
    id: "signal-wake",
    title: "SIGNAL WAKE",
    file: "assets/rewards/signal-wake.png?v=20260623-deepscan1",
    text: "Observation artifact unsealed."
  },
  NEEDLEPOINT_LOBBY: {
    id: "observer-mark",
    title: "OBSERVER MARK",
    file: "assets/rewards/observer-mark.png?v=20260623-deepscan1",
    text: "Observer mark impressed."
  },
  MIRROR_ERROR: {
    id: "relic-access",
    title: "RELIC ACCESS",
    file: "assets/rewards/relic-access.png?v=20260623-deepscan1",
    text: "Relic access card indexed."
  },
  SIGNAL_RELAY: {
    id: "threadbreaker",
    title: "THREADBREAKER",
    file: "assets/rewards/threadbreaker.png?v=20260623-deepscan1",
...
const commandCapstoneReward = {
  id: "route-index",
  title: "ROUTE INDEX",
  file: "assets/rewards/route-index.png?v=20260623-deepscan1",
