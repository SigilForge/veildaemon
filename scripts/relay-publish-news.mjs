...
await fs.writeFile(path.join(entryDir, "index.html"), entryPage(entry).replace('section-block paper', 'section-block').replace(/studio\.css\?v=[^"]+/, 'studio.css?v=20260723-news3'));
