...
function entryPage(record) {
  ...
  return `<!doctype html>
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${esc(record.title)} | SigilForge Studios News</title><meta name="description" content="${esc(record.summary)}"><link rel="canonical" href="https://veildaemon.app${record.canonicalUrl}"><meta property="og:title" content="${esc(record.title)}"><meta property="og:description" content="${esc(record.summary)}"><meta property="og:url" content="https://veildaemon.app${record.canonicalUrl}"><link rel="stylesheet" href="/studio/studio.css?v=20260723-news3"><script src="https://analytics.ahrefs.com/analytics.js" data-key="S+lLE7cqoR0zD/Mvx39AJg" async></script></head><body class="subpage page-shell"><a class="skip-link" href="#main">Skip to content</a><header class="site-header"><a class="brand" href="/studio/"><img src="/studio/assets/brand/sigilforge-emblem-256.webp?v=20260724-sigilforge1" alt="SigilForge Studios"><span><strong>SIGILFORGE</strong><small>STUDIOS</small></span></a><nav aria-label="Primary navigation"><a href="/studio/projects/">Projects</a><a href="/studio/shelf/">Shelf</a><a href="/studio/news/" aria-current="page">News</a><a href="/studio/technology/">Technology</a><a href="/studio/funding/">Funding</a></nav></header><main id="main"><article class="sub-hero text-only"><div><p class="eyebrow">${eyebrow}</p><h1>${esc(record.title)}</h1><p>${esc(record.summary)}</p><p><small>Published ${esc(new Date(record.publishedAt).toLocaleDateString("en-US", { year: "numeric", month: "long", day: "numeric" }))} · ${esc(voice)}</small></p><p><a href="/studio/news/">← Studio News</a></p></div></article><section class="section-block"><div class="news-article-body">${esc(record.body).split("\n\n").map((paragraph) => `<p>${paragraph.replace(/\n/g, "<br>")}</p>`).join("")}</div></section></main></body></html>
`;
}
...
if (!hubPreserved) {
  ...
  await fs.writeFile(path.join(newsRoot, "index.html"), `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Studio News | SigilForge Studios</title><meta name="description" content="Permanent Studio publication record."><link rel="canonical" href="https://veildaemon.app/studio/news/"><link rel="alternate" type="application/rss+xml" href="/studio/news/rss.xml" title="SigilForge Studios News"><link rel="stylesheet" href="/studio/studio.css?v=20260723-news3"><script src="https://analytics.ahrefs.com/analytics.js" data-key="S+lLE7cqoR0zD/Mvx39AJg" async></script></head><body class="subpage page-shell"><main class="section-block"><p class="eyebrow">Studio publication record</p><h1>News</h1><div class="gate-list">${cards}</div></main></body></html>\n`);
  ...
  await fs.writeFile(path.join(newsRoot, "rss.xml"), `<?xml version="1.0" encoding="UTF-8"?><rss version="2.0"><channel><title>SigilForge Studios News</title><link>https://veildaemon.app/studio/news/</link><description>Permanent Studio publication record.</description>${rssItems}</channel></rss>\n`);
} else {
