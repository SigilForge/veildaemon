...
from wick_db import log_wick_event as db_log_wick_event
from wick_obsidian import append_to_obsidian_log
try:
    from wick_api_adapter import fetch_wick_status  # type: ignore
except Exception:
