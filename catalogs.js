(function () {
  ...
  const backgroundCatalog = {
    ...
    NEEDLEPOINT_SURVIVOR: { label: "Needlepoint Survivor", displayName: "Needlepoint Survivor", skillBonus: ["Awareness"], attributeBonus: ["Nerves"], perk: "Advantage on your first roll to recognize a recurring hazard from a previous case.", hook: "You survived a contained impossibility.", tether: "The case did not fully close.", access: "handler" },
    ...
    UNRELIABLE_WITNESS: { label: "Unreliable Witness", displayName: "Unreliable Witness", skillBonus: ["Performance"], attributeBonus: ["Nerves"], perk: "Advantage when insisting on your account under pressure, even when records contradict you.", hook: "You remember what the world edited out.", tether: "Official records say something else happened.", access: "handler" },
