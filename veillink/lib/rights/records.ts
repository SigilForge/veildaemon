...
export const exampleRightsRecords: CreatorRightsRecord[] = [
  {
    ...
    edition: "Book One, second digital edition (v48.1)",
    external_identifier: "SigilForge internal edition v48.1 (previously v47.2C, The Anchor and the Glitch)",
